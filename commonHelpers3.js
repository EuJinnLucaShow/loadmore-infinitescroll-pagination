import{a as r,l as E}from"./assets/lightbox-dad09c9e.js";/* empty css                     */import{i as a}from"./assets/vendor-a94593f8.js";const L=document.getElementById("search-button"),d=document.querySelector(".gallery"),f=document.querySelector("#search-bar"),t=document.querySelector(".btn__load-more");let o=0,i=!0,c="";L.addEventListener("click",function(e){e.preventDefault(),h(),i=!0});f.addEventListener("keydown",function(e){e.key==="Enter"&&(e.preventDefault(),h()),i=!0});function h(){const e=f.value.trim();if(r.setQuery(e),e===""){t.classList.add("is-hidden"),l("Please, fill the main field");return}if(e===c){t.classList.add("is-hidden"),l("Please, modify or enter a new search field.");return}d.innerHTML="",r.resetPage(),c=e,o=0,p()}async function p(){try{const e=await r.fetchGallery(),{hits:s,totalHits:n}=e;if(!s.length){t.classList.add("is-hidden"),u("Sorry, there are no images matching your search query. Please try again.");return}i&&o<n&&(S(`Hooray! We found ${n} images !!!`),i=!1,t.classList.remove("is-hidden")),k(s),o+=s.length,o>=n&&(t.classList.add("is-hidden"),_("You've reached the end of search results."))}catch(e){console.error("Error fetching gallery:",e),u("An error occurred while fetching the gallery.")}}function k(e){const s=e.map(({webformatURL:n,largeImageURL:m,tags:g,likes:y,views:b,comments:w,downloads:v})=>`
      <div class="photo-card">
        ...
        <div class="info">
          ...
          <p class="info-item"><b>Comments</b><span class="info__span">${w}</span></p>
